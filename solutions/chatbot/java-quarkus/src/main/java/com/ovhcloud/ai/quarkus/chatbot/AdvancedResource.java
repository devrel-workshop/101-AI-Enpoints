...
public class AdvancedResource {
  ...
  // Declare a POST method with the "advanced" path and activate the streaming mode
  @Path("advanced")
  @POST
  public Multi<String> ask(String question) {
    // Call the askAQuestion method of the AISimpleService service and stream the answer, see https://quarkus.io/guides/getting-started-reactive
